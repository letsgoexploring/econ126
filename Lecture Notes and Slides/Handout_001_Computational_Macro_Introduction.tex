...
\hspace*{-.5cm}\includegraphics[height = 5cm]{fig_001_rbc_simulation.png}
\end{figure}
}
...
\hspace*{-.5cm}\includegraphics[height = 5cm]{fig_001_mural_concept.png}
\end{figure}
}

\fr{
\begin{figure}[h] \caption{\label{fig2} \textbf{Mural: key coordinates.}}
\hspace*{-.5cm}\includegraphics[height = 5cm]{fig_001_mural_interior_boundary_points.png}
\end{figure}
}

\fr{
\begin{figure}[h] \caption{\label{fig2} \textbf{Mural: final result.}}
\hspace*{-.5cm}\includegraphics[height = 5cm]{fig_001_mural_finished.jpg}
\end{figure}
}
