\begin{figure}[t] \caption{\label{fig:two_per_opt_borrowing} \textbf{A Household that borrows}. The period 0 endowment is small relative to the period 1 endowment}
