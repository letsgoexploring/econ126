...
def tex(x=None):
    ...
    for files in os.listdir('.'):
        if files.endswith('.aux') or files.endswith('.log') or files.endswith('.out') or files.endswith('.gz') or files.endswith('.snm') or files.endswith('.nav') or files.endswith('.toc') or files.endswith('.blg') or files.endswith('.bbl') or files.endswith('.vrb'):
            os.remove(files)
